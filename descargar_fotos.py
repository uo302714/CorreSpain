"""
=============================================================
  CorreSpain — Descargador de fotos de Mapillary
=============================================================

USO:
  1. Ve a https://www.mapillary.com/developer → regístrate → copia tu Access Token
  2. Ejecuta:  python descargar_fotos.py TU_ACCESS_TOKEN
  3. Espera ~5 minutos (busca foto para cada spot, descarga las que encuentra)
  4. Resultado: carpeta 'fotos/' con las imágenes + archivo 'fotos_resultado.json'
...
RADIUS_METROS = 100        # radio de búsqueda inicial
RADIUS_MAX = 500           # radio máximo si no encuentra nada
FOTO_FIELDS = "id,thumb_1024_url,captured_at,compass_angle,is_pano"
CARPETA_FOTOS = "fotos"
PAUSA_ENTRE_REQUESTS = 0.3  # segundos entre peticiones (para no saturar)

# ── Spots (extraídos del HTML) ──────────────────────────────
# Formato: (id, nombre, lat, lng)
SPOTS = [
    (1,"Paseo del Muro de San Lorenzo",43.5475,-5.6616),
    (2,"Senda Costera Gijón-Candás",43.5610,-5.6200),
    ...
    (7,"Senda Fluvial del Nalón",43.3630,-5.8480),
    ...
    (13,"Paseo de la Ría de Avilés",43.5590,-5.9120),
    (14,"Monte Naranco",43.3720,-5.8700),
    (15,"Playa de Rodiles",43.5310,-5.3870),
    (16,"Paseo Marítimo de A Coruña",43.3710,-8.4060),
    (17,"Torre de Hércules Circuit",43.3860,-8.4060),
    (18,"Islas Cíes - Ruta del Faro",42.2310,-8.9050),
    (19,"Senda del Río Verdugo",42.2960,-8.5370),
    (20,"Parque de la Alameda Santiago",42.8740,-8.5490),
    (21,"Brañas do Sar",42.8680,-8.5300),
    (22,"Paseo Fluvial del Lérez",42.4290,-8.6420),
    (23,"Senda Costera de Baiona",42.1170,-8.8490),
    (24,"Playa de las Catedrales",43.5530,-7.1570),
    (25,"Cañón del Sil",42.4150,-7.7480),
    ...
    (31,"Paseo do Río Sar",42.8650,-8.5380),
    ...
    (38,"Peña Cabarga",43.3850,-3.8240),
    (39,"Senda Costera de Suances",43.4390,-4.0470),
    (40,"Vía Verde del Pas",43.2840,-3.9230),
    (41,"Picos de Europa - Fuente Dé",43.1510,-4.8010),
    ...
    (49,"Paseo Nuevo San Sebastián",43.3250,-1.9930),
    (50,"Ría del Nervión Bilbao",43.2690,-2.9350),
    ...
    (109,"Parque de Enrique Tierno Galván",40.3920,-3.6890),
    (110,"Cerro del Tío Pío",40.3870,-3.6510),
    (111,"Parque Forestal de Valdebernardo",40.3780,-3.6120),
    ...
    (116,"Jardín del Capricho",40.4610,-3.6120),
    (117,"Bosque de la Herrería",40.5870,-4.1350),
    (118,"Parque Europa Torrejón",40.4620,-3.4670),
    (119,"Paseo Marítimo Barceloneta",41.3780,2.1920),
    (120,"Carretera de les Aigües",41.4120,2.1280),
    (121,"Montjuïc",41.3640,2.1590),
    (122,"Parc del Fòrum",41.4110,2.2290),
    ...
    (142,"Cala Montgó - L'Escala",42.1180,3.1650),
    ...
    (147,"Parc de Vallparadís",41.5640,2.0120),
    (148,"Costa Daurada Cambrils",41.0690,1.0600),
    (149,"Jardín del Turia",39.4780,-0.3720),
    (150,"Paseo Marítimo Malvarrosa",39.4780,-0.3260),
    ...
    (155,"Paseo Marítimo Benidorm",38.5340,-0.1200),
    (156,"Cap de l'Horta Alicante",38.3490,-0.4060),
    (157,"Explanada de España",38.3450,-0.4840),
    (158,"Parque El Palmeral Alicante",38.3490,-0.4730),
    (159,"Sierra de Bernia",38.6700,-0.0560),
    (160,"Desert de les Palmes",40.0680,0.0500),
    (161,"Playa Norte Peñíscola",40.3710,0.4120),
    (162,"Vía Verde Ojos Negros",39.8500,-0.7500),
    (163,"Parque Natural del Montgó",38.7960,0.1600),
    (164,"Platja de l'Arenal Jávea",38.7590,0.1820),
    (165,"Río Turia Valencia Sur",39.4690,-0.3830),
    (166,"Font Roja Alcoy",38.6670,-0.5430),
    (167,"Clot de Galvany Elche",38.2510,-0.5110),
    (168,"Palmeral de Elche",38.2660,-0.6960),
    (169,"Sierra de Espadán",39.8790,-0.3550),
    (170,"Playa de Gandía",38.9930,-0.1630),
    (171,"Parque Natural de las Salinas Torrevieja",37.9780,-0.7020),
    (172,"Greenway Xurra",39.5100,-0.3700),
    (173,"Serra Calderona",39.6530,-0.4200),
    (174,"Parque de María Luisa",37.3720,-5.9870),
    (175,"Alamillo Sevilla",37.4120,-5.9970),
    (176,"Canal de Alfonso XIII",37.3630,-6.0020),
    (177,"Muelle de la Sal - Triana",37.3830,-6.0020),
    (178,"Paseo Marítimo Málaga",36.7130,-4.4200),
    (179,"Montes de Málaga",36.7650,-4.3800),
    (180,"Desembocadura del Guadalhorce",36.6890,-4.4550),
    (181,"Playa de la Barrosa",36.3810,-6.1910),
    (182,"Paseo Marítimo Cádiz",36.5270,-6.2920),
    ...
    (188,"Ribera del Guadalquivir Córdoba",37.8870,-4.7770),
    (189,"Medina Azahara Trail",37.8880,-4.8670),
    (190,"Paraje Natural Marismas del Odiel",37.2190,-6.9630),
    (191,"Playa de Matalascañas",36.9880,-6.5650),
    (192,"Parque Natural de Cazorla",37.9130,-2.9240),
    (193,"Cabo de Gata",36.7260,-2.1880),
    (194,"Paseo Marítimo Almería",36.8360,-2.4550),
    (195,"Paseo Marítimo Estepona",36.4250,-5.1470),
    (196,"Paseo Marítimo Marbella",36.5050,-4.8840),
    ...
    (211,"Paseo del Parque Málaga",36.7170,-4.4150),
    (212,"Acantilados de Maro",36.7440,-3.8450),
    (213,"Puerto Real - Caño Sancti Petri",36.5240,-6.1790),
    (214,"Ribera del Ebro Zaragoza",41.6570,-0.8790),
    (215,"Parque Grande José Antonio Labordeta",41.6370,-0.8910),
    (216,"Canal Imperial de Aragón",41.6340,-0.9050),
    (217,"Galacho de Juslibol",41.6950,-0.8900),
    (218,"Valle de Ordesa",42.6630,-0.0550),
    (219,"Mallos de Riglos",42.3580,-0.7270),
    (220,"Sendero del Río Turia Teruel",40.3450,-1.1060),
    (221,"Albarracín Trails",40.4080,-1.4440),
    ...
    (227,"Camino del Cid Aragón",41.0380,-0.2910),
    (228,"Parque del Agua Zaragoza",41.6850,-0.8570),
    (229,"Senda Ecológica Toledo",39.8580,-4.0260),
    (230,"Ribera del Tajo Toledo",39.8560,-4.0330),
    (231,"Tablas de Daimiel",39.1450,-3.7150),
    (232,"Lagunas de Ruidera",38.9320,-2.8800),
    (233,"Parque Abelardo Sánchez",38.9950,-1.8580),
    (234,"Hoz del Júcar Cuenca",40.0700,-2.1300),
    (235,"Ciudad Encantada Trail",40.2090,-1.9600),
    (236,"Parque de la Concordia Guadalajara",40.6340,-3.1650),
    (237,"Río Henares Guadalajara",40.6320,-3.1580),
    (238,"Molinos del Guadiana",38.9910,-3.9280),
    (239,"Hayedo de Tejera Negra",41.2380,-3.2620),
    (240,"Parque Nacional de Cabañeros",39.3980,-4.2930),
    (241,"Nacimiento del Río Mundo",38.4990,-2.4490),
    (242,"Alarcón - Embalse",39.6880,-2.0940),
    (243,"Vía Verde de la Jara",39.6070,-4.9350),
    (244,"Ribera del Jerte",40.1180,-5.8640),
    (245,"Monfragüe",39.8430,-5.9650),
    (246,"Ribera del Guadiana Badajoz",38.8720,-6.9670),
    (247,"Parque del Príncipe Cáceres",39.4760,-6.3730),
    (248,"Embalse de Proserpina",38.9640,-6.3680),
    (249,"Paseo Fluvial Mérida",38.9120,-6.3430),
    ...
    (278,"Mirador del Río Trail Lanzarote",29.2130,-13.4800),
    (279,"Paseo Marítimo Palma",39.5660,2.6290),
    (280,"Serra de Tramuntana - Sóller",39.7660,2.7150),
    (281,"Cala Mondragó",39.3450,3.1890),
    (282,"Camí de Cavalls Menorca",39.9430,3.8230),
    (283,"Cala Macarella Menorca",39.9370,3.9300),
    (284,"Ses Salines Ibiza",38.8670,1.3720),
    (285,"Santa Eulària des Riu",38.9870,1.5350),
    (286,"Cap de Formentor",39.9620,3.1630),
    (287,"Platja de Muro",39.8080,3.1070),
    (288,"Torrent de Pareis",39.8510,2.8230),
    (289,"Paseo Marítimo de Ceuta",35.8920,-5.3130),
    (290,"Monte Hacho",35.8870,-5.2830),
    (291,"Parque Marítimo del Mediterráneo",35.8910,-5.3140),
    (292,"Paseo Marítimo de Melilla",35.2920,-2.9380),
    (293,"Parque de los Pueblos de España",35.2880,-2.9510),
    (294,"Rostrogordo",35.2840,-2.9620),
    (295,"Playa de la Concha - Algeciras",36.1310,-5.4530),
    (296,"Embalse de El Atazar",40.9060,-3.4750),
    (297,"Paseo Fluvial Ávila",40.6530,-4.6990),
    (298,"Playa de las Teresitas Tenerife",28.5090,-16.1880),
    (299,"Parque Natural de s'Albufera Mallorca",39.7930,3.1060),
    (300,"Senda del Duero Zamora",41.5010,-5.7560),
]


def buscar_foto(lat, lng, token, radio=RADIUS_METROS):
    """Busca la foto más cercana en Mapillary a unas coordenadas."""
    params = {
        "access_token": token,
        "fields": FOTO_FIELDS,
        "lat": lat,
    ...
    try:
        r = requests.get(MAPILLARY_API, params=params, timeout=10)
        r.raise_for_status()
        data = r.json().get("data", [])
        if not data:
            return None
        # Preferir panorámicas, luego la más reciente
        panos = [d for d in data if d.get("is_pano")]
        mejor = panos[0] if panos else data[0]
        return {
            "mapillary_id": mejor["id"],
            "url": mejor.get("thumb_1024_url", ""),
            "captured_at": mejor.get("captured_at", ""),
            "is_pano": mejor.get("is_pano", False),
        }
...
def main():
    if len(sys.argv) < 2:
        print("❌ Uso: python descargar_fotos.py TU_ACCESS_TOKEN_DE_MAPILLARY")
        print("")
        print("   Consigue tu token en: https://www.mapillary.com/developer")
        sys.exit(1)
    ...
    print(f"🏃 CorreSpain — Buscando fotos para {len(SPOTS)} spots...")
    print(f"   Carpeta de salida: {CARPETA_FOTOS}/")
    print(f"   Esto tardará ~3-5 minutos\n")

    for i, (sid, nombre, lat, lng) in enumerate(SPOTS):
        pct = f"[{i+1}/{len(SPOTS)}]"
        print(f"{pct} {nombre} ({lat}, {lng})...", end=" ", flush=True)

        # Buscar con radio inicial
        foto = buscar_foto(lat, lng, token, RADIUS_METROS)

        # Si no encuentra, ampliar radio
        if not foto and RADIUS_METROS < RADIUS_MAX:
            foto = buscar_foto(lat, lng, token, RADIUS_MAX)

        if foto and foto["url"]:
            filepath = os.path.join(CARPETA_FOTOS, f"spot_{sid}.jpg")
            ok = descargar_imagen(foto["url"], filepath)
            if ok:
                print(f"✅ descargada")
                encontradas += 1
                resultados[str(sid)] = {
                    "archivo": filepath,
                    "mapillary_id": foto["mapillary_id"],
                    "is_pano": foto["is_pano"],
                }
            else:
                print(f"❌ fallo descarga")
                no_encontradas += 1
        else:
            print(f"— sin cobertura")
            no_encontradas += 1
    ...
    print(f"   Sin cobertura:     {no_encontradas}/{len(SPOTS)}")
    print(f"   Guardadas en:      {CARPETA_FOTOS}/")
    print(f"   Resumen en:        fotos_resultado.json")
    print(f"\nSiguiente paso: sube la carpeta '{CARPETA_FOTOS}/' a Supabase Storage")
    print(f"o sirve las imágenes desde tu repo en Vercel.")
